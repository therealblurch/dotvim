...
let g:colorscheme_map = [
         ...
         \ {'name': 'onehalf',          'cmparison': 'fuzzy', 'lightlinetheme': 'onehalfdark', 'variant_type': 'colorscheme', 'variant_base': 'onehalf', 'variants': ['light', 'dark']},
         ...
         \ {'name': 'solarized8',       'comparison': 'fuzzy', 'lightlinetheme': 'colorscheme',      'runtime': 'true', 'airlinetheme': 'colorscheme', 'variant_type': 'colorscheme_bg', 'variants': ['', '_low', '_flat', '_high']},
