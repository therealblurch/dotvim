...
let g:colorscheme_map = [
         \ {'name': 'Base2Tone',        'lightlinetheme': 'dropbg',           'runtime': 'true', 'airlinetheme': 'colorscheme', 'variant_type': 'colorscheme', 'variant_base': 'drop', 'variants': ['Light', 'Dark']},
         ...
         \ {'name': 'corvine', 'variant_type': 'colorscheme', 'variant_base': 'corvine', 'variants': ['', '_light']},
         ...
         \ {'name': 'flattened',        'lightlinetheme': 'colorscheme',      'airlinetheme': 'colorscheme', 'variant_type': 'colorscheme', 'variant_base': 'drop', 'variants': ['_light', '_dark']},
         ...
         \ {'name': 'hybrid_material', 'variant_type': 'background'},
         \ {'name': 'hybrid_reverse', 'variant_type': 'background'},
         ...
         \ {'name': 'material',         'lightlinetheme': 'material_vim',     'runtime': 'true', 'variant_type': 'material_theme_stype', 'variants': ['default', 'palenight', 'ocean', 'lighter', 'darker']},
         ...
         \ {'name': 'onehalf',          'lightlinetheme': 'onehalfdark', 'variant_type': 'colorscheme', 'variant_base': 'onehalf', 'variants': ['light', 'dark']},
         ...
         \ {'name': 'solarized8',       'lightlinetheme': 'colorscheme',      'runtime': 'true', 'airlinetheme': 'colorscheme', 'variant_type': 'colorscheme_bg', 'variants': ['', '_low', '_flat', '_high']},
