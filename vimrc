...
function! PackagerInit() abort
  ...
  call packager#init()
  call packager#add('brooth/far.vim', {'package': 'general'})
  call packager#add('airblade/vim-gitgutter', {'package': 'general'})
  call packager#add('chrisbra/NrrwRgn', {'package': 'general'})
  call packager#add('cohama/agit.vim', {'package': 'general'})
  call packager#add('drmikehenry/vim-fontsize', {'package': 'general'})
  call packager#add('easymotion/vim-easymotion', {'package': 'general'})
  call packager#add('idanarye/vim-merginal', {'package': 'general'})
  call packager#add('nishigori/increment-activator', {'package': 'general'})
  call packager#add('garbas/vim-snipmate', {'package': 'general'})
  call packager#add('haya14busa/is.vim', {'package': 'general'})
  call packager#add('haya14busa/vim-asterisk', {'package': 'general'})
  call packager#add('honza/vim-snippets', {'package': 'general'})
  call packager#add('itchyny/lightline.vim', {'package': 'general', 'type': 'opt'})
  call packager#add('jreybert/vimagit', {'package': 'general'})
  call packager#add('junegunn/vim-easy-align', {'package': 'general'})
  call packager#add('junegunn/vim-peekaboo', {'package': 'general'})
  call packager#add('justinmk/vim-sneak', {'package': 'general'})
  call packager#add('kshenoy/vim-signature', {'package': 'general'})
  call packager#add('lifepillar/vim-mucomplete', {'package': 'general'})
  call packager#add('liuchengxu/vim-which-key', {'package': 'general'})
  call packager#add('luochen1990/rainbow', {'package': 'general'})
  call packager#add('machakann/vim-highlightedyank', {'package': 'general'})
  call packager#add('MarcWeber/vim-addon-mw-utils', {'package': 'general'})
  call packager#add('markonm/traces.vim', {'package': 'general'})
  call packager#add('mhinz/vim-grepper', {'package': 'general'})
  call packager#add('mox-mox/vim-localsearch', {'package': 'general'})
  call packager#add('myusuf3/numbers.vim', {'package': 'general'})
  call packager#add('Olical/vim-enmasse', {'package': 'general'})
  call packager#add('osyo-manga/vim-anzu', {'package': 'general'})
  call packager#add('pelodelfuego/vim-swoop', {'package': 'general'})
  call packager#add('Raimondi/delimitMate', {'package': 'general'})
  call packager#add('rbong/vim-flog', {'package': 'general'})
  call packager#add('rhysd/committia.vim', {'package': 'general'})
  call packager#add('rhysd/conflict-marker.vim', {'package': 'general'})
  call packager#add('rhysd/git-messenger.vim', {'package': 'general'})
  call packager#add('ryanoasis/vim-devicons', {'package': 'general'})
  call packager#add('sainnhe/lightline_foobar.vim', {'package': 'general', 'type': 'opt'})
  call packager#add('scrooloose/nerdtree', {'package': 'general'})
  call packager#add('sjl/gundo.vim', {'package': 'general'})
  call packager#add('taohexxx/lightline-buffer', {'package': 'general', 'type': 'opt'})
  call packager#add('tommcdo/vim-lion', {'package': 'general'})
  call packager#add('tomtom/tcomment_vim', {'package': 'general'})
  call packager#add('tomtom/tinykeymap_vim', {'package': 'general'})
  call packager#add('tomtom/tlib_vim', {'package': 'general'})
  call packager#add('tpope/vim-capslock', {'package': 'general'})
  call packager#add('tpope/vim-dispatch', {'package': 'general'})
  call packager#add('tpope/vim-endwise', {'package': 'general'})
  call packager#add('tpope/vim-fugitive', {'package': 'general'})
  call packager#add('tpope/vim-obsession', {'package': 'general'})
  call packager#add('tpope/vim-sensible', {'package': 'general'})
  call packager#add('tpope/vim-sleuth', {'package': 'general'})
  call packager#add('tpope/vim-speeddating', {'package': 'general'})
  call packager#add('tpope/vim-surround', {'package': 'general'})
  call packager#add('tpope/vim-unimpaired', {'package': 'general'})
  call packager#add('tyru/capture.vim', {'package': 'general'})
  call packager#add('unblevable/quick-scope', {'package': 'general'})
  call packager#add('vhda/verilog_systemverilog.vim', {'package': 'general'})
  call packager#add('vim-airline/vim-airline', {'package': 'general', 'type': 'opt'})
  call packager#add('vim-airline/vim-airline-themes', {'package': 'general', 'type': 'opt'})
  call packager#add('vim-scripts/VisIncr', {'package': 'general'})
  call packager#add('wellle/targets.vim', {'package': 'general'})
  call packager#add('wellle/visual-split.vim', {'package': 'general'})
  call packager#add('xolox/vim-misc', {'package': 'general'})
  call packager#add('xolox/vim-colorscheme-switcher', {'package': 'general'})
  call packager#add('Xuyuanp/nerdtree-git-plugin', {'package': 'general'})
  call packager#add('Yggdroot/indentline', {'package': 'general'})
  call packager#add('zhuzhzh/verilog_emacsauto.vim', {'package': 'general'})
  call packager#add('AndrewRadev/switch.vim', {'package': 'general'})
  call packager#add('adriaanzon/vim-textobj-matchit', {'package': 'general'})
  call packager#add('deathlyfrantic/vim-textobj-blanklines', {'package': 'general'})
  call packager#add('fvictorio/vim-textobj-backticks', {'package': 'general'})
  call packager#add('gilligan/textobj-gitgutter', {'package': 'general'})
  call packager#add('glts/vim-textobj-comment', {'package': 'general'})
  call packager#add('glts/vim-textobj-indblock', {'package': 'general'})
  call packager#add('Julian/vim-textobj-brace', {'package': 'general'})
  call packager#add('kana/vim-textobj-datetime', {'package': 'general'})
  call packager#add('kana/vim-textobj-diff', {'package': 'general'})
  call packager#add('kana/vim-textobj-entire', {'package': 'general'})
  call packager#add('kana/vim-textobj-fold', {'package': 'general'})
  call packager#add('kana/vim-textobj-function', {'package': 'general'})
  call packager#add('kana/vim-textobj-indent', {'package': 'general'})
  call packager#add('kana/vim-textobj-user', {'package': 'general'})
  call packager#add('paulhybryant/vim-textobj-path', {'package': 'general'})
  call packager#add('rhysd/vim-textobj-continuous-line', {'package': 'general'})
  call packager#add('saaguero/vim-textobj-pastedtext', {'package': 'general'})
  call packager#add('sgur/vim-textobj-parameter', {'package': 'general'})
  call packager#add('thinca/vim-textobj-between', {'package': 'general'})
  call packager#add('vimtaku/vim-textobj-keyvalue', {'package': 'general'})
