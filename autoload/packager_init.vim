function! packager_init#PackagerInit() abort
  ...
  " colorschemes
  call packager#add('ackyshake/Spacegray.vim',                {'package': 'colors'})
  call packager#add('arcticicestudio/nord-vim',               {'package': 'colors'})
  ...
  call packager#add('https://therealblurch@github.com/therealblurch/cosmic_latte',      {'package': 'colors'})
  call packager#add('https://therealblurch@github.com/therealblurch/seabird',           {'package': 'colors'})
  call packager#add('https://therealblurch@github.com/therealblurch/snow',              {'package': 'colors'})
  call packager#add('https://therealblurch@github.com/therealblurch/stellarized',       {'package': 'colors'})
  call packager#add('https://therealblurch@github.com/therealblurch/vimspectr',         {'package': 'colors'})
