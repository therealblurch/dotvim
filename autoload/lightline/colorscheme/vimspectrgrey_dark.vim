let s:base00 = [ '#141414',  0 ] " black
let s:base01 = [ '#2b2b2b', 18 ]
let s:base02 = [ '#6b6b6b', 19 ]
let s:base03 = [ '#6b6b6b',  8 ]
let s:base04 = [ '#8a8a8a', 20 ]
let s:base05 = [ '#8a8a8a',  7 ]
...
let g:lightline#colorscheme#vimspectrgrey_dark#palette = lightline#colorscheme#flatten(s:p)
